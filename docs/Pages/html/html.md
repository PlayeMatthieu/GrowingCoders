...
HTML of **HyperText Markup Language** is een programmataal die ervoor zorgt dat bepaalde onderdelen op de website getoond worden. De code is opgebouwd uit tags. De tags bevinden zich altijd tussen <>.

## Opbouw html

Een html pagina moet altijd gedeclareerd worden met de `<!DOCTYPE html>`. Het openen en sluiten van onze code start en eindigt met de `<html> </html>` tag. Om verder te verdiepen in de opbouw bevat onze html document een `<head>` en `<body>` tag. In de `<head>` tag staat meer informatie over onze website. Dit kunnen volgende elementen zijn.
...
Dan is er de `<body>`, dit is alles wat zichtbaar zal zijn op de webpagina.
...
Semantische elementen zijn nieuw met **HTML5**. Ze zorgen ervoor om duidelijke structuur te creëren in onze document. Als tweede zorgen ze ervoor dat zoekmachines een beter idee hebben van hoe onze website is opgebouwd.
...
```html
<form method="Post" action="UitTevoerenScript.js"></form>
```
...
<head>
  ...
  <meta
    name="description"
    content="GrowingCoders is een referentie voor startende programmeurs als ze iets vergeten zijn. Hier kun je snel een eenvoudig vinden wat je zoekt."
  />
  <meta name="author" content="GrowingCoders" />
  <meta name="application-name" content="GrowingCoders website" />
  <meta
    name="keywords"
    content="HTML, CSS, Javascript, SQL, C#, Git, Markdown, Snippets, Leren programmeren, GrowingCoders"
  />
  ...
  <meta
    property="og:image"
    content="https://growingcoders.tech/Assets/Img/logos/GrowingCoders.svg"
  />
  <meta
    name="viewport"
